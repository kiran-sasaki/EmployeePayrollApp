...
const createInnerHtml=()=>{
    ...
    <tr>
        <td><img class="profile" alt="" src="Profile2.jpg"></td>
        <td> Narayan Mahadevan</td>
        <td>Male</td>
        <td>
            <div>HR</div>
        ...
        <td>1 nov 2020</td>
        <td>
            <img id="1" onclick="remove(this)" alt="delete" src="delete.jpeg">
            <img id="1" onclick="update(this)" alt="edit" src="edit.jpeg">
        </td>
    </tr>
    `;
    document.querySelector('#table-display').innerHTML=innerHtml;
